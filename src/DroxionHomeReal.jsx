...
async function loadAllDiscoverableProfiles() {
  ...
  while (true) {
    const { data, error } = await supabase
      ...
      .select('user_id, display_name, bio, date_of_birth, country, language, gender, interests, avatar_url, discovery_enabled, show_country, allow_messages, allow_video_calls')
