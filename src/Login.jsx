    ...
    <div className="min-h-screen bg-[#07070b] text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-[#111118] border border-white/10 rounded-3xl p-7 shadow-2xl">
        ...
        <form onSubmit={handleLogin}>
          ...
          <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" required placeholder="Your password" className="w-full p-3 mb-6 bg-[#191922] border border-white/10 rounded-xl outline-none focus:border-purple-500" />

          <button type="submit" disabled={loading} className="w-full bg-purple-600 hover:bg-purple-500 disabled:opacity-60 py-3 rounded-xl font-bold">
