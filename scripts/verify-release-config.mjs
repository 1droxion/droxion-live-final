...
if (!codemagic.includes('ANDROID_VERSION_NAME: "1.2"')) throw new Error('Android release version is not aligned to 1.2.');
...
console.log('Release configuration verified: com.droxion.live, Android 1.2, target SDK 36.');
